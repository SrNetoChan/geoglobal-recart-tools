...
class SnapViaRodovLimiteCurvaDeNivel(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        sql_path = os.path.join(script_path, 'SnapViaRodovLimiteCurvaDeNivel.sql')
    ...
    def name(self):
        return 'SnapViaRodovLimiteCurvaDeNivel'

    def displayName(self):
        return 'Snap limite de via rodoviária a curvas de nível'
    ...
    def shortHelpString(self):
        return self.tr(
            ...
            "<p><b>ATENÇÃO:</b> Esta ferramenta altera directamente as tabelas via_rodov_limite e curva_de_nivel, sendo criados backups no schema backups</p>"
